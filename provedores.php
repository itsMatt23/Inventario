...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['create'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO Proveedores (Cedula, Nombre, Apellido, Ciudad, Direccion, Telefono, Email, contrasena) VALUES ('$cedula', '$nombre', '$apellido', '$ciudad', '$direccion', '$telefono', '$email', '$contrasena')";
            $conexion->query($sql);
        }
        ...
        $sql = "UPDATE Proveedores SET Nombre='$nombre', Apellido='$apellido', Ciudad='$ciudad', Direccion='$direccion', Telefono='$telefono', Email='$email', contrasena='$contrasena' WHERE Cedula='$cedula'";
        $conexion->query($sql);
...
<body>
    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <div class="container flex-grow-1 mt-3">
            ...
            <form method="get" action="provedores.php" class="mb-4">
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        ...
                        <a href="provedores.php" class="btn btn-outline-secondary">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="provedores.php">
                                                    ...
                                                    <div class="form-group" >
                                                        ...
                                                        <input type="password" class="form-control" name="contrasena" value="<?php echo $proveedor['contrasena']; ?>">
                                                    </div>
